...
#define CC_TO_BE16(x)   (x)
#define CC_TO_BE32(x)   (x)
#define CC_TO_BE64(x)   (x)
#define CC_FROM_BE16(x) (x)
#define CC_FROM_BE32(x) (x)
#define CC_FROM_BE64(x) (x)
#endif
